  ...
  return (
    <div className='flex flex-col'>
        ...
        <section id='hero' className='h-[30svh] w-[100svw] flex flex-col justify-center items-center gap-4 mb-[5svh]'>
            <span className='bg-orange-100 rounded-3xl text-orange-500 font-bold text-[10px] w-fit py-1 px-3'>MOVIE TICKET PURCHASES #1 IN INDONESIA</span>
            <div className='flex flex-col gap-1 justify-center items-center'>
                <span className='text-[2svw] font-bold'>Experience the Magic of Cinema:</span>
                <span className='text-[2svw] font-extrabold text-orange-500'>Book Your Tickets Today</span>
            </div>
            <span className='text-[12px]'>Sign up and get the ticket with a lot of discount</span>
        </section>
        ...
        <section id='benefit' className='w-[100svw] h-[60svh] bg-white'>
          <div className='w-[99svw] h-full bg-black rounded-2xl flex flex-col justify-center items-center'>
              <div className='flex flex-row w-[80%] h-[60%] justify-between'>
                <div className='flex flex-col justify-start items-start w-[40%] h-full'>
                  <span className='bg-orange-100 rounded-3xl text-orange-500 font-bold text-[10px] w-fit py-2 px-5'>WHY CHOOSE US</span>
                ...
                <div className='w-[60%] h-full flex flex-row gap-10'>
                  <div className='w-[30%] h-full rounded-2xl bg-orange-100 flex flex-col justify-between py-5 px-5 box-border'>
                    <div className='flex flex-col gap-2'>
                      <img src={affordable} className='size-[3svw]' alt="icon" />
                      <span className='font-bold text-lg'>Affordable</span>
                    </div>
                    <span className='font-light text-sm'>Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec, proin faucibus nibh et sagittis a.</span>
                  </div>
                  <div className='w-[30%] h-full rounded-2xl bg-orange-100 flex flex-col justify-between py-5 px-5 box-border'>
                    <div className='flex flex-col gap-2'>
                      <img src={guaranted} className='size-[3svw]' alt="icon" />
                      <span className='font-bold text-lg'>Guaranted</span>
                    </div>
                    <span className='font-light text-sm'>Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec, proin faucibus nibh et sagittis a.</span>
                  </div>
                  <div className='w-[30%] h-full rounded-2xl bg-orange-100 flex flex-col justify-between py-5 px-5 box-border'>
        ...
        <section id='upcoming' className='w-[100svw] h-[60svh] bg-gray-100 flex flex-row justify-center items-center gap-5 pb-5 mb-5 mt-5'>
          ...
          <div className='flex flex-col justify-between w-1/4 h-[90%]'>
            <div className='flex flex-col justify-start'>
              <span className='bg-orange-100 rounded-3xl text-orange-500 font-bold text-[10px] w-fit py-2 px-3'>UPCOMING MOVIES</span>
