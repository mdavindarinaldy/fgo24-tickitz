...
function RegisterPage() {
  return (
    <main className='w-svw min-h-svh max-h-fit bg-cover bg-center bg-no-repeat flex flex-col justify-center items-center' style={{backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url(${backdrop})`}}>
      <img src={logo} alt="icon-logo" className='w-[20svw]'/>
      <form id='register' className='flex flex-col gap-5 w-[40%] h-[75%] bg-white rounded-2xl px-10 py-5 mb-10'>
        <Steps/>
        <Input type='fullname'/>
        ...
        <span className='text-center'>Already have an account? <Link to='/login' className='text-blue-700'>Log In</Link></span>
        ...
        <div className='flex flex-row justify-between gap-3'>
          <div className='flex flex-col gap-2 justify-center items-center border-1 border-gray-400 flex-1 rounded-2xl py-5 hover: cursor-pointer'>
            ...
            <span className='text-sm text-gray-400'>Sign Up with Google Account</span>
          </div>
          <div className='flex flex-col gap-2 justify-center items-center border-1 border-gray-400 flex-1 rounded-2xl py-5 hover: cursor-pointer'>
            <FaFacebook className='size-10'/>
            <span className='text-sm text-gray-400'>Sign Up with Facebook Account</span>
          </div>
        </div>
      </form>
    </main>
